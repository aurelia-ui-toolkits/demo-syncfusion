export class BasicUse {
  constructor() {
    ...
    this.shapesettings = { highlightBorderWidth: 1, strokeThickness: 0.5, autoFill: false, stroke: 'white', highlightStroke: 'white', highlightColor: '#AFAFAF', valuePath: 'Electors', colorValuePath: 'Candidate', selectionColor: '#EFB856', selectionStroke: 'White', selectionStrokeWidth: 2.5, colorMappings: { equalColorMapping: [ { value: 'Romney', color: '#D84444' }, { value: 'Obama', color: '#316DB5' }]}};
  }
}
