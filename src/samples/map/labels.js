export class BasicUse {
  constructor() {
    ...
    this.labelsettings = { showLabels: true, labelPath: 'iso_3166_2', enableSmartLabel: true };
    this.shapesettings = { autoFill: false, highlightBorderWidth: 1, strokeThickness: 0.5, stroke: 'white', highlightColor: '#DAD1CF', highlightStroke: '#1A5D65', valuePath: 'population', selectionColor: '#FFC200', selectionStroke: 'white', selectionStrokeWidth: 2.5, colorMappings: { rangeColorMapping: [ { from: 500000, to: 1000000, color: '#9BC585' }, { from: 1000001, to: 5000000, color: '#D2DB9A' }, { from: 5000001, to: 10000000, color: '#A4D4BF'}, { from: 10000001, to: 40000000, color: '#E0C68F'}]}};
  }
}
