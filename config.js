System.config({
  ...
  "bundles": {
    "app-build-f56bdd185f": [
      ...
      "npm:aurelia-binding@1.1.1",
      "npm:aurelia-binding@1.1.1/aurelia-binding",
      "npm:aurelia-bootstrapper@1.0.1",
      ...
      "npm:aurelia-framework@1.0.8",
      "npm:aurelia-framework@1.0.8/aurelia-framework",
      "npm:aurelia-history-browser@1.0.0",
      ...
      "npm:aurelia-pal@1.2.0/aurelia-pal",
      ...
      "npm:aurelia-router@1.1.1",
      "npm:aurelia-router@1.1.1/aurelia-router",
      "npm:aurelia-syncfusion-bridge@0.5.0",
      "npm:aurelia-syncfusion-bridge@0.5.0/accordion/accordion",
      "npm:aurelia-syncfusion-bridge@0.5.0/autocomplete/autocomplete",
      "npm:aurelia-syncfusion-bridge@0.5.0/barcode/barcode",
      "npm:aurelia-syncfusion-bridge@0.5.0/bulletgraph/bulletgraph",
      "npm:aurelia-syncfusion-bridge@0.5.0/bulletgraph/qualitativerange",
      "npm:aurelia-syncfusion-bridge@0.5.0/button/button",
      "npm:aurelia-syncfusion-bridge@0.5.0/chart/chart",
      "npm:aurelia-syncfusion-bridge@0.5.0/chart/series",
      "npm:aurelia-syncfusion-bridge@0.5.0/checkbox/checkbox",
      "npm:aurelia-syncfusion-bridge@0.5.0/circulargauge/circulargauge",
      "npm:aurelia-syncfusion-bridge@0.5.0/colorpicker/colorpicker",
      "npm:aurelia-syncfusion-bridge@0.5.0/common/common",
      "npm:aurelia-syncfusion-bridge@0.5.0/common/constants",
      "npm:aurelia-syncfusion-bridge@0.5.0/common/decorators",
      "npm:aurelia-syncfusion-bridge@0.5.0/common/events",
      "npm:aurelia-syncfusion-bridge@0.5.0/common/template",
      "npm:aurelia-syncfusion-bridge@0.5.0/common/template-processor",
      "npm:aurelia-syncfusion-bridge@0.5.0/common/util",
      "npm:aurelia-syncfusion-bridge@0.5.0/common/widget-base",
      "npm:aurelia-syncfusion-bridge@0.5.0/config-builder",
      "npm:aurelia-syncfusion-bridge@0.5.0/currencytextbox/currencytextbox",
      "npm:aurelia-syncfusion-bridge@0.5.0/datepicker/datepicker",
      "npm:aurelia-syncfusion-bridge@0.5.0/datetimepicker/datetimepicker",
      "npm:aurelia-syncfusion-bridge@0.5.0/diagram/diagram",
      "npm:aurelia-syncfusion-bridge@0.5.0/dialog/dialog",
      "npm:aurelia-syncfusion-bridge@0.5.0/digitalgauge/digitalgauge",
      "npm:aurelia-syncfusion-bridge@0.5.0/dropdownlist/dropdownlist",
      "npm:aurelia-syncfusion-bridge@0.5.0/fileexplorer/fileexplorer",
      "npm:aurelia-syncfusion-bridge@0.5.0/gantt/gantt",
      "npm:aurelia-syncfusion-bridge@0.5.0/grid/column",
      "npm:aurelia-syncfusion-bridge@0.5.0/grid/grid",
      "npm:aurelia-syncfusion-bridge@0.5.0/groupbutton/groupbutton",
      "npm:aurelia-syncfusion-bridge@0.5.0/heatmap/heatmap",
      "npm:aurelia-syncfusion-bridge@0.5.0/heatmaplegend/heatmaplegend",
      "npm:aurelia-syncfusion-bridge@0.5.0/index",
      "npm:aurelia-syncfusion-bridge@0.5.0/kanban/kanban",
      "npm:aurelia-syncfusion-bridge@0.5.0/kanban/kanbancolumn",
      "npm:aurelia-syncfusion-bridge@0.5.0/lineargauge/lineargauge",
      "npm:aurelia-syncfusion-bridge@0.5.0/listbox/listbox",
      "npm:aurelia-syncfusion-bridge@0.5.0/listview/listview",
      "npm:aurelia-syncfusion-bridge@0.5.0/map/layer",
      "npm:aurelia-syncfusion-bridge@0.5.0/map/map",
      "npm:aurelia-syncfusion-bridge@0.5.0/maskedit/maskedit",
      "npm:aurelia-syncfusion-bridge@0.5.0/menu/menu",
      "npm:aurelia-syncfusion-bridge@0.5.0/navigationdrawer/navigationdrawer",
      "npm:aurelia-syncfusion-bridge@0.5.0/numerictextbox/numerictextbox",
      "npm:aurelia-syncfusion-bridge@0.5.0/overview/overview",
      "npm:aurelia-syncfusion-bridge@0.5.0/pager/pager",
      "npm:aurelia-syncfusion-bridge@0.5.0/pdfviewer/pdfviewer",
      "npm:aurelia-syncfusion-bridge@0.5.0/percentagetextbox/percentagetextbox",
      "npm:aurelia-syncfusion-bridge@0.5.0/pivotchart/pivotchart",
      "npm:aurelia-syncfusion-bridge@0.5.0/pivotgauge/pivotgauge",
      "npm:aurelia-syncfusion-bridge@0.5.0/pivotgrid/pivotgrid",
      "npm:aurelia-syncfusion-bridge@0.5.0/pivotschemadesigner/pivotschemadesigner",
      "npm:aurelia-syncfusion-bridge@0.5.0/pivottreemap/pivottreemap",
      "npm:aurelia-syncfusion-bridge@0.5.0/progressbar/progressbar",
      "npm:aurelia-syncfusion-bridge@0.5.0/radialmenu/item",
      "npm:aurelia-syncfusion-bridge@0.5.0/radialmenu/radialmenu",
      "npm:aurelia-syncfusion-bridge@0.5.0/radialslider/radialslider",
      "npm:aurelia-syncfusion-bridge@0.5.0/radiobutton/radiobutton",
      "npm:aurelia-syncfusion-bridge@0.5.0/rangenavigator/rangenavigator",
      "npm:aurelia-syncfusion-bridge@0.5.0/rangenavigator/rangeseries",
      "npm:aurelia-syncfusion-bridge@0.5.0/rating/rating",
      "npm:aurelia-syncfusion-bridge@0.5.0/reportviewer/reportviewer",
      "npm:aurelia-syncfusion-bridge@0.5.0/ribbon/ribbon",
      "npm:aurelia-syncfusion-bridge@0.5.0/rotator/rotator",
      "npm:aurelia-syncfusion-bridge@0.5.0/rte/rte",
      "npm:aurelia-syncfusion-bridge@0.5.0/schedule/schedule",
      "npm:aurelia-syncfusion-bridge@0.5.0/schedule/scheduleresource",
      "npm:aurelia-syncfusion-bridge@0.5.0/scroller/scroller",
      "npm:aurelia-syncfusion-bridge@0.5.0/signature/signature",
      "npm:aurelia-syncfusion-bridge@0.5.0/slider/slider",
      "npm:aurelia-syncfusion-bridge@0.5.0/sparkline/sparkline",
      "npm:aurelia-syncfusion-bridge@0.5.0/splitbutton/splitbutton",
      "npm:aurelia-syncfusion-bridge@0.5.0/splitter/splitter",
      "npm:aurelia-syncfusion-bridge@0.5.0/spreadsheet/sheet",
      "npm:aurelia-syncfusion-bridge@0.5.0/spreadsheet/spreadsheet",
      "npm:aurelia-syncfusion-bridge@0.5.0/sunburstchart/sunburstchart",
      "npm:aurelia-syncfusion-bridge@0.5.0/sunburstchart/sunburstlevels",
      "npm:aurelia-syncfusion-bridge@0.5.0/symbolpalette/symbolpalette",
      "npm:aurelia-syncfusion-bridge@0.5.0/tab/tab",
      "npm:aurelia-syncfusion-bridge@0.5.0/tagcloud/tagcloud",
      "npm:aurelia-syncfusion-bridge@0.5.0/tile/tile",
      "npm:aurelia-syncfusion-bridge@0.5.0/timepicker/timepicker",
      "npm:aurelia-syncfusion-bridge@0.5.0/togglebutton/togglebutton",
      "npm:aurelia-syncfusion-bridge@0.5.0/toolbar/toolbar",
      "npm:aurelia-syncfusion-bridge@0.5.0/tooltip/tooltip",
      "npm:aurelia-syncfusion-bridge@0.5.0/treegrid/treegrid",
      "npm:aurelia-syncfusion-bridge@0.5.0/treegrid/treegridcolumn",
      "npm:aurelia-syncfusion-bridge@0.5.0/treemap/level",
      "npm:aurelia-syncfusion-bridge@0.5.0/treemap/treemap",
      "npm:aurelia-syncfusion-bridge@0.5.0/treeview/treeview",
      "npm:aurelia-syncfusion-bridge@0.5.0/uploadbox/uploadbox",
      "npm:aurelia-syncfusion-bridge@0.5.0/waitingpopup/waitingpopup",
      "npm:aurelia-task-queue@1.1.0",
      "npm:aurelia-task-queue@1.1.0/aurelia-task-queue",
      "npm:aurelia-templating-binding@1.2.0",
      "npm:aurelia-templating-binding@1.2.0/aurelia-templating-binding",
      "npm:aurelia-templating-resources@1.2.0",
      "npm:aurelia-templating-resources@1.2.0/abstract-repeater",
      "npm:aurelia-templating-resources@1.2.0/analyze-view-factory",
      "npm:aurelia-templating-resources@1.2.0/array-repeat-strategy",
      "npm:aurelia-templating-resources@1.2.0/attr-binding-behavior",
      "npm:aurelia-templating-resources@1.2.0/aurelia-hide-style",
      "npm:aurelia-templating-resources@1.2.0/aurelia-templating-resources",
      "npm:aurelia-templating-resources@1.2.0/binding-mode-behaviors",
      "npm:aurelia-templating-resources@1.2.0/binding-signaler",
      "npm:aurelia-templating-resources@1.2.0/compose",
      "npm:aurelia-templating-resources@1.2.0/css-resource",
      "npm:aurelia-templating-resources@1.2.0/debounce-binding-behavior",
      "npm:aurelia-templating-resources@1.2.0/dynamic-element",
      "npm:aurelia-templating-resources@1.2.0/focus",
      "npm:aurelia-templating-resources@1.2.0/hide",
      "npm:aurelia-templating-resources@1.2.0/html-resource-plugin",
      "npm:aurelia-templating-resources@1.2.0/html-sanitizer",
      "npm:aurelia-templating-resources@1.2.0/if",
      "npm:aurelia-templating-resources@1.2.0/map-repeat-strategy",
      "npm:aurelia-templating-resources@1.2.0/null-repeat-strategy",
      "npm:aurelia-templating-resources@1.2.0/number-repeat-strategy",
      "npm:aurelia-templating-resources@1.2.0/repeat",
      "npm:aurelia-templating-resources@1.2.0/repeat-strategy-locator",
      "npm:aurelia-templating-resources@1.2.0/repeat-utilities",
      "npm:aurelia-templating-resources@1.2.0/replaceable",
      "npm:aurelia-templating-resources@1.2.0/sanitize-html",
      "npm:aurelia-templating-resources@1.2.0/set-repeat-strategy",
      "npm:aurelia-templating-resources@1.2.0/show",
      "npm:aurelia-templating-resources@1.2.0/signal-binding-behavior",
      "npm:aurelia-templating-resources@1.2.0/throttle-binding-behavior",
      "npm:aurelia-templating-resources@1.2.0/update-trigger-binding-behavior",
      "npm:aurelia-templating-resources@1.2.0/with",
      "npm:aurelia-templating-router@1.0.1",
      ...
      "npm:aurelia-templating@1.2.0",
      "npm:aurelia-templating@1.2.0/aurelia-templating",
