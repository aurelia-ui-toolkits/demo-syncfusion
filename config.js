System.config({
  ...
  "paths": {
    ...
    "common/ej.*": "jspm_packages/npm/syncfusion-javascript@14.4.15/Scripts/ej/common/ej.*.js",
    "datavisualization/ej.*": "jspm_packages/npm/syncfusion-javascript@14.4.15/Scripts/ej/datavisualization/ej.*.js",
    "ej.*": "jspm_packages/npm/syncfusion-javascript@14.4.15/Scripts/ej/web/ej.*.js",
    "syncfusion-javascript/*": "jspm_packages/npm/syncfusion-javascript@14.4.15/*",
    "syncfusion-ej-global": "jspm_packages/npm/syncfusion-ej-global@14.4.15/*"
  },
  "meta": {
  ...
  "map": {
    ...
    "syncfusion-widgets": "npm:syncfusion-javascript@14.4.15",
    ...
    "npm:syncfusion-javascript@14.4.15": {
      "jquery": "npm:jquery@2.2.4",
      "jquery-validation": "npm:jquery-validation@1.15.1",
      "jquery-validation-unobtrusive": "npm:jquery-validation-unobtrusive@3.2.6",
      "jsrender": "npm:jsrender@0.9.83",
      "syncfusion-ej-global": "npm:syncfusion-ej-global@14.4.15"
    },
    "npm:through2@2.0.1": {
      "process": "github:jspm/nodelibs-process@0.1.2",
